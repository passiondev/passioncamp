...
class RegisterTest extends TestCase
{
    ...
    {
        factory(Organization::class)->create(['slug' => 'ms']);

        return $this->postJson(route('register.create', ['event' => 'ms']), $this->data = array_merge([
            'contact' => [
                'first_name' => 'Matt',
                'last_name' => 'Floyd',
    ...
    {
        return array_sum([
            $this->data['num_tickets'] * (new Occurrence(config('occurrences.ms')))->ticketPrice(),
    ...
    public function can_register()
    {
        ...
        $this->assertEquals((new Occurrence(config('occurrences.ms')))->ticketPrice() * 100, $order->tickets->first()->price);
    ...
    public function it_redirects_to_confirmation_if_successful()
    {
        ...
        $response->assertRedirect(route('register.confirmation', ['event' => 'ms']));
    ...
    public function order_is_not_created_if_payment_fails()
    {
        ...
        $response->assertRedirect(route('register.create', ['event' => 'ms']));
