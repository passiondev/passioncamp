<div style="font-family:system-ui, Helvetica Neue, Arial, Helvetica, sans-serif;font-size:16px;">
    ...
    @if ($order->user->balance)
        <div style="margin:1.5rem auto; background-color: #F8FAFC; padding: 1rem; text-align:center">
            ...
            <div style="font-size:14px; font-style: italic; color: #8795A1; margin-bottom: 0; margin-top: 10px">
                @if ($order->user->isRegistered())
