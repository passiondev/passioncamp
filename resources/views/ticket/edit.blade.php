...
@section('content')
    <div class="container">
        ...
        <footer class="d-flex justify-content-end">
            <a href="{{ action('TicketController@delete', $ticket) }}" class="btn btn-danger" onclick="event.preventDefault(); document.getElementById('delete-form').submit();">Delete Attendee</a>
        </footer>
